...
const CustomInput = ({
	...
	return (
		<div className='border-b-[1px] border-secondary  px-4 py-3 flex backdrop-blur-md rounded-2xl'>
			{icon}
			<input
				type={type}
	...
	return (
		...
		>
			...
			<PhoneInput
				...
				onChange={setPhone}
				containerClass='!border-b-[1px] border-secondary px-1 flex '
				inputClass={`!bg-transparent !w-full !text-lg !text-secondary !h-full !border-none backdrop-blur-md !rounded-2xl ${
