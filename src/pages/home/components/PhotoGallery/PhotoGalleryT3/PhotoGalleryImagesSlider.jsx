								...
								return (
									...
									>
										...
										<div
											...
											} transition-all duration-500 flex justify-center items-center absolute p-4 lg:p-8 z-40 bg-white/40 backdrop-blur-[10px] text-primary text-center text-base md:text-2xl rounded-2xl max-md:w-[90%] bottom-[2%] md:bottom-[10%] left-1/2 transform -translate-x-1/2`}
										>
